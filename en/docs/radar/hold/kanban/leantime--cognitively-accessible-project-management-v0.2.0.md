...
dc:subject:
  ...
  - "neurodiversity"
dc:description: "Radar entry assessing Leantime, an AGPL-3.0-licensed project management platform designed for cognitive accessibility, with ADHD, autism, and dyslexia as first-class design constraints. Full evaluation against Universal Cake Evaluation Metrics v0.3.1. Moved to hold, WeKan adopted for the current need."
