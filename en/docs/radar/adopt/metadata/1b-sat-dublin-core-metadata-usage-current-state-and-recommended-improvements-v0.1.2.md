...
|---------|--------|-------|
| 0.1.2 | Approved | Closes radar-1b item 2.2, "confirmed, not assumed" standard like  the dc:type work: the gap was verified against the actual current table before drafting, not just recalled from the original card. |
