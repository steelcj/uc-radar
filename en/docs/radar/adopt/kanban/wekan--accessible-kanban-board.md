...
dc:subject:
  ...
  - "accessibility"
  - "wcag"
dc:description: "Radar entry assessing WeKan, an MIT-licensed self-hosted Kanban board with recently verified WCAG 2.1 AA accessibility work, including keyboard-driven card reordering without drag-and-drop."
